...
export class ApprovalsService {
   ...
   */
  async getApprovalFlows(adminUserId: number) {
   ...
   */
  async createApprovalFlow(adminUserId: number, flowData: any) {
    const adminUser = await this.prisma.user.findUnique({ where: { id: adminUserId } });
   ...
   */
  async updateApprovalFlow(flowId: number, adminUserId: number, flowData: any) {
    const adminUser = await this.prisma.user.findUnique({ where: { id: adminUserId } });
   ...
   */
  async deleteApprovalFlow(flowId: number, adminUserId: number) {
    const adminUser = await this.prisma.user.findUnique({ where: { id: adminUserId } });
  ...
  /**
   * Get approval rules for company (Admin only)
   */
  async getApprovalRules(adminUserId: number) {
    const adminUser = await this.prisma.user.findUnique({ where: { id: adminUserId } });
   ...
   */
  async createApprovalRule(adminUserId: number, ruleData: any) {
    const adminUser = await this.prisma.user.findUnique({ where: { id: adminUserId } });
   ...
   */
  async updateApprovalRule(ruleId: number, adminUserId: number, ruleData: any) {
    const adminUser = await this.prisma.user.findUnique({ where: { id: adminUserId } });
   ...
   */
  async deleteApprovalRule(ruleId: number, adminUserId: number) {
    const adminUser = await this.prisma.user.findUnique({ where: { id: adminUserId } });
